...
module.exports = function(app) {
	...
	app.delete('/api/publicG/:param1', function(req, res) {
            ...
            // fs.read(__dirname + "/" + "publicGJSON.json", "utf8", function(err,data){        // Does not work    - fs.read is deprecated
            // fs.readFile(__dirname + "/" + "publicGJSON.json", "utf8", function(err,data){    // this syntax works               
            // fs.readFile("publicGJSON.json", "utf8", function(err,data){                      // this syntax works
            // fs.readFile("./publicGJSON.json", "utf8", function(err,data){                    // this syntax works
            
            fs.readFile("./publicGJSON1.json", "utf8", function(err,data){    
                if (err) {
                ...
                //dataA["msg11"] = JSON.parse(paramObj.param1)["msg11"];    // add record - this syntax works
                
                //dataA["msg11"] = JSON.parse(paramObj.param1)["msg11"];      // add record, swap with delete record to re-demonstrate.
                delete dataA["msg11"];                                      // delete a record, swap with add record to re-demonstrate.
            ...
            var writeData = function(dataA){
                fs.writeFile('publicGJSON1.json', JSON.stringify(dataA), function(err) {
                    if (err) {
                        return console.error(err);
                    }
                    console.log('*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#');
	...
	app.get('*', function(req, res) {
		res.sendFile(__dirname + '/publicGindex.html'); // load the single view file (angular will handle the page changes on the front-end)
	});
